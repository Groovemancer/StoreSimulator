...
public class Customer : MonoBehaviour
{
            ...
            case CustomerState.entering:
                ...
                else
                {
                    if (StoreController.instance.shelvingCases.Count > 0)
                    {
                        ...
                        browsePointsRemain = UnityRandom.Range(1, maxBrowsePoints);
    ...
    {
        points.Clear();
        int selectedShelf = UnityRandom.Range(0, StoreController.instance.shelvingCases.Count);

        points.Add(new NavPoint());
        points[0].point = StoreController.instance.shelvingCases[selectedShelf].standPoint;
        points[0].waitTime = browseTime * UnityRandom.Range(0.75f, 1.25f);
        currentWaitTime = points[0].waitTime;
    ...
    public void GrabStock()
    {
        ...
        int shelf = UnityRandom.Range(0, currentShelfCase.shelves.Count);
        ...
        if (stock != null)
        {
            ...
            points[0].waitTime = waitAfterGrabbing * UnityRandom.Range(0.75f, 1.25f);
            currentWaitTime = points[0].waitTime;
        }
    }
